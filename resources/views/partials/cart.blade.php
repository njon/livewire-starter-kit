...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <h3 class="mb-4">{{ __('Your Shopping Cart') }}</h3>
        </div>
    </div>
        ...
        <div class="col-lg-4 col-md-5">
            <div class="mb-4">
                <div class="">
                    ...
                    <!-- Coupon Code Input -->
                    <div class="mb-4">
                        <label for="couponCode" class="form-label">{{ __('Have a coupon?') }}</label>
                        <div class="input-group">
                            <input type="text" class="form-control" id="couponCode" placeholder="{{ __('Enter coupon code') }}">
                            <button class="btn btn-outline-secondary" type="button">{{ __('Apply') }}</button>
                        </div>
                    </div>
                    ...
                    <div class="d-grid mt-4">
                        <a href="/checkout" class="btn btn-primary btn-lg py-3">{{ __('Proceed to Checkout') }}</a>
                    </div>
                </div>
            </div>
        </div>
