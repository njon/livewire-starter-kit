                    ...
                    <tr>
                        <td class="ps-4">
                            <div class="d-flex align-items-center gap-3">
                                @if($line->purchasable->product->thumbnail->getUrl())
                                <img src="{{ $line->purchasable->product->thumbnail->getUrl() }}" 
                ...
                <div class="row g-4">
                    <div class="col-md-6">
                        ...
                        <div class="border-bottom pb-3 mb-3">
                            ...
                            <p class="mb-0">{{ $order->sub_total->formatted() }}</p>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="border-bottom pb-3 mb-3">
                            ...
                            <p class="mb-0">{{ $order->tax_total->formatted() }}</p>
                        </div>
                        
                        <div class="border-bottom pb-3 mb-3">
                            <h6 class="fs-14 text-muted mb-2">Total</h6>
                            <p class="mb-0">{{ $order->total->formatted() }}</p>
                        </div>
                        
                        <div class="border-bottom pb-3 mb-3">
                            <h6 class="fs-14 text-muted mb-2">Paid</h6>
                            <p class="mb-0">{{ $order->captures ? $order->captures?->first()->amount->formatted() : 'Not paid' }}</p>
                        </div>
            ...
            <div class="card-body">
                ...
                <div class="border-bottom pb-3 mb-3 last:border-0 last:pb-0 last:mb-0">
                    ...
                    <p class="mb-0 text-muted fs-14">
                        Payment received via {{ $transaction->provider }} | Payment intent: {{ $transaction->reference }}
                    </p>
                </div>
                @endforeach
            </div>
