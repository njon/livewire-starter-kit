...
<head>
    ...
    <link rel="stylesheet" href="https://animated-dollop-g5v44x4gg5fwq7-80.app.github.dev/css/admin.css" crossorigin="anonymous">
    ...
    <script>const languages = {!! json_encode(\Lunar\Models\Language::all('code')->pluck('code')->toArray()) !!};</script>
...
<body>
    <nav class="topbar">
        <div class="sidebar-brand">
            <h2><a href="https://animated-dollop-g5v44x4gg5fwq7-80.app.github.dev/"><i class="bi bi-moon-stars"></i> LunarPHP</a></h2>
        </div>
        <ul class="topbar-nav">
            <li class="nav-item">
