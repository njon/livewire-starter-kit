...
@section('toolbar')
    @include('admin.partials.buttons', ['title' => 'Add Article', 'asset' => 'Article', 'buttons' => [
        ['save' => true]
    ]])
@endsection

@section('content')
<form method="POST" action="{{ route('admin.articles.store') }}" class="submit-form">
    @csrf
    <div class="card mb-4 border-0 shadow-sm">
        <div class="card-header bg-transparent border-bottom py-3">
            <h3 class="h5 mb-0">{{ __('Add Article') }}</h3>
        </div>
        <div class="card-body">
            <!-- Language Tabs -->
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control tinymce @error('content.'.$language->code) is-invalid @enderror"
                                          ...
                                          rows="15">{{ old('content.'.$language->code) }}</textarea>
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('meta_description.'.$language->code) is-invalid @enderror"
                                          ...
                                          rows="3" maxlength="255">{{ old('meta_description.'.$language->code) }}</textarea>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                        <div class="form-text">{{ __('Slug will be auto-generated from title. Whitespaces removed, Greek letters converted to Latin.') }}</div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="mb-3">
            ...
            <div class="row" id="published-date-field" style="display: none;">
                <div class="col-md-6">
                    <div class="mb-3">
