<div class="dropdown-item">
    <div class="activity-item">
        <div class="activity-icon order bg-primary bg-opacity-10 text-primary">
...
<div class="dropdown-item">
    <div class="activity-item">
        <div class="activity-icon user bg-success bg-opacity-10 text-success">
...
<div class="dropdown-item">
    <div class="activity-item">
        <div class="activity-icon store bg-info bg-opacity-10 text-info">
