<nav class="fi-breadcrumbs">
    <ol class="fi-breadcrumbs-list ">
        <li class="fi-breadcrumbs-item">Products</li>
        <li class="fi-breadcrumbs-item">
            ...
            <span class="fi-breadcrumbs-item-label">List</span>
        </li>
    </ol>
</nav>
    ...
    <div class="d-flex gap-2">
        @foreach($buttons as $button)
            ...
            @if(isset($button['save']))
                <button type="button" class="btn btn-primary" onclick="document.querySelector('.submit-form').submit();">Save Service</button>
            @endif
