                                ...
                                <div class="card mb-4 shadow-sm">
                                    <div class="card-header bg-light">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                <span class="fw-bold">{{ __('Order #:ref', ['ref' => $order->reference]) }}</span>
                                                <span
                                                        ...
                                                        <div class="d-flex align-items-center mb-3">
                                                            <div class="flex-shrink-0 me-3">
                                                                ...
                                                                <img src="{{ $line->purchasable->product->thumbnail->getUrl('small') }}"
                                                                    alt="{{ __('Product image') }}" class="img-fluid rounded"
                                                            ...
                                                            <div class="flex-grow-1">
                                                                <h5 class="mb-1">{{ $line->purchasable->product->translateAttribute('name') ?? __('N/A') }}</h5>
                                                                <p class="mb-1 text-muted ">{{ __('Quantity: :count items', ['count' => $line->quantity]) }}</p>
                                                            </div>
                                                        </div>
                                                        @endforeach
                                                    </div>
                    ...
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('invite.send') }}">
                                ...
                                <div class="mb-3">
                                    <label for="emails" class="form-label">{{ __('Email Addresses (comma separated)') }}</label>
